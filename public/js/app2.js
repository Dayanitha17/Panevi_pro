...
// Carrito de compras almacenado en un array
let carrito = [];
...
function pagarClicked() {
    ...
    // Enviar los datos del carrito a la página resumen_compra.php
...
function getCartItems() {
    ...
    for (var i = 0; i < items.length; i++) {
        ...
        carritoItems.push({ titulo: titulo, precio: precio, cantidad: cantidad });
    }
    return carritoItems;
}
